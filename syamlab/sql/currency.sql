...
-- Volcando estructura para tabla prueba.currency
...
CREATE TABLE IF NOT EXISTS `currency` (
  ...
  KEY `CurrencyISO_Language` (`currency_ISO`,`language`)    
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
 
-- Volcando datos para la tabla prueba.currency: ~636 rows (aproximadamente)
